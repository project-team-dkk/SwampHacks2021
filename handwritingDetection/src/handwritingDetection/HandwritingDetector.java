...
public class HandwritingDetector {
	 ...
	 * @param filePathThe path to the image file
	 * @throws IOException
	 */
					...
					for (Block block : page.getBlocksList()) {
						...
						for (Paragraph para : block.getParagraphsList()) {
							...
							for (Word word : para.getWordsList()) {
								...
								TextAnnotation.TextProperty wordProperty = word.getProperty();
								TextAnnotation.DetectedLanguage detectedLang = wordProperty.getDetectedLanguages(0);
								System.out.format(
										"Language: %s%n", detectedLang.getLanguageCode());
